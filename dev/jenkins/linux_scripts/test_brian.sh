...
~/.jenkins/virtual_envs/$PythonVersion/$packages/bin/coverage run --branch ~/.jenkins/virtual_envs/$PythonVersion/$packages/bin/nosetests --with-xunit --verbose brian/tests || :
