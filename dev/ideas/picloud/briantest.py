...
# List of stdp_example arguments
# We can use currently up to 16 units in parallel. 
ilist = [1000 for _ in xrange(16)]
t1 = time.clock()

# Gets the jobs ids
print "Launching %d jobs..." % (len(ilist))
jids = cloud.map(stdp_example, ilist)
time.sleep(5)
print

print "Jobs status :"
print cloud.status(jids)
print
