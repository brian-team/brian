...
G = SpikeGeneratorGroup(N, [(i, t*second) for i in xrange(10) for t in arange(repeats)*interval], clock=clk)
Gd = SpikeGeneratorGroup(N, [(i, t*second+i*max_delay/N) for i in xrange(10) for t in arange(repeats)*interval], clock=clk)
