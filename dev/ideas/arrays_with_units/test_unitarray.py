...
print_eval('np.float32(23) * metre')
...
print '\n\tChanging data types / removing units'
print_eval('(np.array([1, 2, 3]) * metre).astype(np.int32)')
print_eval('np.int32(np.array([1, 2, 3]) * metre)')
