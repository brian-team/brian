...
dBlevel=80  # dB level in rms dB SPL
...
lp_l=LowPassFilterbank(samplerate, nbr_center_frequencies,cutoff_frequencies_linear)
lowpass_linear=CascadeFilterbank(lp_l,4)

#linear pathway
linear_path=FilterbankChain([bandpass_linear,gain,lowpass_linear])
...
lp_nl=LowPassFilterbank(samplerate, nbr_center_frequencies,cutoff_frequencies_nonlinear)
...
lowpass_nonlinear=CascadeFilterbank(lp_nl,3)
...
brian_hears=dnrl_monitor.getvalues()
data=dict()
