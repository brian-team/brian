...
x = Sound(array([randn(1000), zeros(1000)]).T, rate=44100*Hz)
w = Sound(array([linspace(-1, 1, 1000), sin(linspace(0, 2*pi, 1000))]).T, rate=44100*Hz)
#w = Sound(sin(linspace(0, 2*pi, 1000)), rate=44100*Hz)
