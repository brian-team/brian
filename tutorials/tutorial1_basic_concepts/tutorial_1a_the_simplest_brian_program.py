...
Brian class :class:`Model`, initialised with the values in the
...
'''
The ``N`` keyword gives the number of neurons in the group and the
``model`` keyword is used to pass the neuron model.
